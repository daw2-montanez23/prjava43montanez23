...
public class Prjava43montanez23 extends Frame 
   ...
   public Prjava43montanez23() { 
      ...
      setTitle("nova finesta prjava43montanez23");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43montanez23();  // Let the construct do the job 
   } 
